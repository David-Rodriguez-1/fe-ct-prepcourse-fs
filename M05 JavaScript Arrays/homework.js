...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   return arrayOfNums.reduce((acc, value) => {
      return acc + value
   }, 0)
}
...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   return Math.floor(resultadosTest.reduce((acc, valor, ind, arr) => {
      return acc + valor / arr.length;
   }, 0))
}
...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   return arrayOfNums.reduce((acc, valor) => {
